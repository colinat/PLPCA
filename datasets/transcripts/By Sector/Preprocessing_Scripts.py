...
# Save to file
fn_out = f'transcript_corpus_{sector}.txt'
...
# ### Source: https://colab.research.google.com/drive/1ywsvwO6thOVOrfagjjfuxEf6xVRxbUNO
...
get_ipython().system('pip install pytorch-pretrained-bert pytorch-nlp -q')
...
# choices=["bert-base-uncased", "bert-large-uncased", "bert-base-cased", "bert-base-multilingual-uncased", "bert-base-chinese", "bert-base-multilingual-cased"])
...
# ### input ids: 
# a sequence of integers identifying each input token to its index number in the BERT tokenizer vocabulary
...
# ### attention mask: 
# Create the attention masks (optional), a sequence of 1s and 0s, with 1s for all input tokens and 0s for all padding tokens
